<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Inscricoes.aspx.vb" Inherits="ProjetoLives.Inscricoes" %>
                        ...
                        <div class="col-12">
                            <div class="panel panel-default">
                                <div class="row mt-2">
                                    ...
                                    <div class="col-3">
                                        <label>Live:</label>
                                        <asp:TextBox ID="txtLiveFiltro" runat="server" CssClass="form-control mw-100" MaxLength="200"></asp:TextBox>
                                    </div>
                                    <div class="col-3">
                                        <label>Inscrito:</label>
                                        <asp:TextBox ID="txtInscritoFiltro" runat="server" CssClass="form-control mw-100" MaxLength="200"></asp:TextBox>
                                    </div>
                                    <div class="col-4">
                                        <label>Data de Vencimento:</label>
                                        <div class="row">
                                            <div class="col-5">
                                                <asp:TextBox ID="txtDataVencimentoFiltro" runat="server" CssClass="form-control mw-100" type="Date"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <ContentTemplate>
                    <asp:GridView ID="grd" runat="server" AutoGenerateColumns="false"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField HeaderText="Lives" DataField="Lives" />
                            <asp:BoundField HeaderText="Inscritos" DataField="Inscritos" />                           
                            <asp:BoundField HeaderText="Data de Vencimento" DataField="DataVencimento" DataFormatString="{0:dd/MM/yyyy}" />
                            <asp:BoundField HeaderText="Status Pagamento" DataField="StatusPagamento" />
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-12">
                                        <span>Live:</span>
                                        <asp:DropDownList ID="cmbLive" runat="server" Width="100%" CssClass="form-control dropdown-toggle" AutoPostBack="true" OnSelectedIndexChanged="RetornaValorComboLive"></asp:DropDownList>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-12">
                                        <span>Inscrito:</span>
                                        <asp:DropDownList ID="cmbInscrito" runat="server" Width="100%" CssClass="form-control dropdown-toggle"></asp:DropDownList>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-5">
                                        <label>Data de Vencimento:</label>
                                        <asp:TextBox ID="txtDataVencimento" runat="server" CssClass="form-control mw-100" TextMode="Date"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-12">
                                        <span>Inscrição paga?</span>
                                        <asp:RadioButtonList ID="rblOpcao" runat="server" RepeatDirection="Horizontal">
